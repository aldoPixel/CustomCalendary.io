!(function (t) {
  ...
  function (t, e, n) {
    function r(t, e) {
      ...
      if (v) {
        ...
        return (
          ...
          l.timezone
            ? (m = u(l.timezone))
            : ((m = new Date(y + D).getTimezoneOffset()),
              (m = new Date(y + D + m * f).getTimezoneOffset())),
          new Date(y + D + m * f)
        );
      }
      return new Date(t);
    ...
    function s(t) {
      var e, n, r;
      if ((e = N.exec(t)))
        return ((n = parseFloat(e[1].replace(",", "."))) % 24) * h;
      if ((e = C.exec(t)))
        return (
          (n = parseInt(e[1], 10)),
    ...
    (r.prototype.on = function (t, e, n) {
          ...
          if (this._events.hasOwnProperty(i) && (o = this._events[i])) {
            if (((this._events[i] = r = []), e || n))
              for (var s = 0, u = o.length; s < u; s++)
                (a = o[s]),
                  ((e && e !== a.callback && e !== a.callback._callback) ||
                    (n && n !== a.context)) &&
                    r.push(a);
      ...
      (r.prototype.trigger = function (t) {
        if (this._events) {
          ...
          if (n)
            for (var o in n)
              n.hasOwnProperty(o) && (r = n[o]).callback.apply(r.context, e);
        }
      }),
      (e.default = r);
  },
  ...
  function (t, e, n) {
    var r = n(3),
      ...
      s = function (t, e, n) {
        ...
        f && (n = e);
        for (u in n)
          ((l = !h && D && void 0 !== D[u]) && u in m) ||
            ((c = l ? D[u] : n[u]),
            (m[u] =
              f && "function" != typeof D[u]
                ? n[u]
                : g && l
                ? o(c, r)
                : v && D[u] == c
    ...
    var a = n(32),
      ...
      y = function (t, e, n, r) {
        ...
        if (e) {
          ...
          try {
            for (
              var h, f = (0, l.default)((0, s.default)(e));
              !(i = (h = f.next()).done);
              i = !0
            ) {
        ...
        if (n) {
          ...
          try {
            for (
              var D, b = (0, l.default)((0, s.default)(n));
              !(v = (D = b.next()).done);
              v = !0
            ) {
  ...
  function (t, e, n) {
    ...
    function a(t, e, n) {
      ...
      return function (t) {
        for (var e = "", n = 0; n < s; n++)
          i[n] instanceof Function ? (e += i[n](t, p)) : (e += i[n]);
        return e;
      };
    }
    function o(t) {
  ...
  function (t, e, n) {
    ...
    t.exports = function (t) {
      ...
      return void 0 === t
        ...
        : null === t
        ? "Null"
        : "string" == typeof (n = i((e = Object(t)), a))
        ? n
        : o
        ? r(e)
  ...
  function (t, e, n) {
    ...
    function a(t) {
      var e = t.startDate,
        ...
        $ = t.disabledDates,
        B = void 0 === $ ? null : $;
      (this.disabledDates = null === B ? null : this._parseDisabledDates(B)),
        (this.showHeader = G),
        (this.double = v),
        ...
        (this.singleDate = O),
        (this.startDate =
          null === n ? null : (0, S.default)(n) ? n : (0, P.default)(n)),
        (this.endDate =
          null === a ? null : (0, S.default)(a) ? a : (0, P.default)(a)),
        null === this.startDate && (this.endDate = null),
        (this.minDate = null === i ? null : (0, C.default)(i)),
        (this.maxDate = null === u ? null : (0, C.default)(u)),
        (this.outputFormat = c),
        (this.dateSeparator = y),
        (this.currentDate =
          null !== this.startDate ? this.startDate : new Date()),
        (this.input = p),
        (this.mondayIsFirst = Y),
        (this.placeholderText = F),
        (this.enableMonthSwitcher = H),
        (this.enableYearSwitcher = R),
        (this.labelTo = w),
        (this.labelFrom = T),
        (this.container = f),
        (this.locale = L),
        ...
        b
          ...
          : ((this.popupVisibility = !1), this._bindPopupEve()),
    ...
    u.default ||
      (Object.entries = function (t) {
        for (var e = (0, i.default)(t), n = e.length, r = new Array(n); n--; )
          r[n] = [e[n], t[e[n]]];
        return r;
      }),
      (a.prototype = new k.default()),
      ...
      (a.prototype._showPopup = function (t) {
        if (!this.popupVisibility) {
          var e = t.getBoundingClientRect(),
            ...
            i = this.double ? { w: 600, h: 400 } : { w: 420, h: 400 },
            s = void 0,
            u = void 0,
            l = "";
          n > i.h && o > i.w
            ? ((s = a),
              (u = window.pageYOffset + r + e.height + 13),
              (l = " top-left-triangle"))
            : n > i.h && a > i.w
            ? ((s = a - i.w + e.width),
              (u = window.pageYOffset + r + e.height + 13),
              (l = " top-right-triangle"))
            : r > i.h && o > i.w
            ? ((s = a),
              (u = window.pageYOffset + r - i.h - 13),
              (l = " bottom-left-triangle"))
            : r > i.h && a > i.w
            ? ((s = a - i.w + e.width),
              (u = window.pageYOffset + r - i.h - 13),
              (l = " bottom-right-triangle"))
            : ((s = a),
              (u = window.pageYOffset + r + e.height + 13),
              (l = " top-left-triangle")),
            this._render({ left: s, top: u, className: l }),
            this._bindEvents(),
            this._bindKeyboard(),
            (this.popupVisibility = !0);
        }
      ...
      (a.prototype._setInputVal = function () {
        var t = "";
        null !== this.startDate &&
          (t = (0, M.default)(this.startDate, this.outputFormat)),
          null !== this.endDate &&
            (t =
              t +
              " " +
              this.dateSeparator +
              " " +
              (0, M.default)(this.endDate, this.outputFormat)),
      ...
      (a.prototype._bindEvents = function () {
        ...
        this.on("set:date", function (e) {
          t.trigger("select:before", (0, M.default)(e, t.outputFormat)),
            null === t.startDate || t.singleDate
              ? t.trigger("change:startDate", e)
              : null !== t.startDate && null === t.endDate
              ? -1 !== (0, w.default)(t.startDate, e)
                ? ((t.endDate = t.startDate),
                  (t.startDate = e),
                  t.trigger("change:startDate", t.startDate),
                  t.trigger("change:endDate", t.endDate))
                : t.trigger("change:endDate", e)
              : null !== t.startDate &&
                null !== t.endDate &&
                ...
                t.trigger("change:startDate", e),
                t.trigger("change:endDate", null)),
            t.trigger("select:after", (0, M.default)(e, t.outputFormat));
        }),
          this.on("set:hoverDate", function (e) {
            t.hoverDate !== e &&
              ((t.hoverDate = e),
              null !== t.minDate &&
                -1 === (0, w.default)((0, P.default)(t.hoverDate), t.minDate) &&
                (t.hoverDate = (0, M.default)(t.minDate, "YYYY-MM-DD")),
              null !== t.maxDate &&
                -1 === (0, w.default)(t.maxDate, (0, P.default)(t.hoverDate)) &&
                (t.hoverDate = (0, M.default)(t.maxDate, "YYYY-MM-DD")),
              t.trigger("change:hoverDate", t.hoverDate));
          }),
          ...
          this.on("change:startDate", function (e) {
            t.trigger(
              ...
              null === e ? null : (0, M.default)(e, t.outputFormat)
            ),
              (t.startDate = e),
              t._applyHeaderTitles(),
              t._setInputVal(),
              t.trigger(
                "firstDateSelect:after",
                null === e ? null : (0, M.default)(e, t.outputFormat)
              );
          }),
          this.on("change:endDate", function (e) {
            t.trigger(
              "secondDateSelect:before",
              null === e ? null : (0, M.default)(e, t.outputFormat)
            ),
              (t.endDate = e),
              t._applyHeaderTitles(),
              t._setInputVal(),
              t.trigger(
                "secondDateSelect:after",
                null === e ? null : (0, M.default)(e, t.outputFormat)
              );
          }),
          this.on("change:monthPanel", function () {
            if (
              (t.enableMonthSwitcher &&
                (t.chooseMonthPanel = !t.chooseMonthPanel),
              !t.chooseMonthPanel)
            )
              return (
                (t.monthNameContainer.className = "month-name-container"),
                void (
                  t.monthChooseContainer &&
                  t.calendarContainer.removeChild(t.monthChooseContainer)
                )
              );
            (t.monthNameContainer.className =
              "month-name-container monthChoose"),
              t._renderMonthChoose();
          }),
          this.on("change:yearPanel", function () {
            if (
              (t.enableYearSwitcher && (t.chooseYearPanel = !t.chooseYearPanel),
              !t.chooseYearPanel)
            )
              return (
                (t.monthNameContainer.className = "month-name-container"),
                void (
                  ...
                  t.calendarContainer.removeChild(t.yearChooseContainer)
                )
              );
            (t.monthNameContainer.className =
              "month-name-container yearChoose"),
              t._renderYearChoose();
          });
      }),
      ...
      (a.prototype._bindKeyboard = function () {
        ...
        this.keyboardEvents &&
          ((this._keyEvent = function (e) {
            if (27 === e.keyCode) {
              if (t.chooseMonthPanel)
                return void t.trigger("change:monthPanel");
      ...
      (a.prototype._destroy = function () {
        if (this.popupVisibility) {
          this.trigger("hide:before"),
            document.removeEventListener("keyup", this._keyEvent),
            this.container.removeChild(this.calendarContainer),
            this.inline || this.container.removeChild(this.blackout),
          ...
          for (var t in this._events)
            this._events.hasOwnProperty(t) &&
              ...
              "select:before" !== t &&
              "select:after" !== t &&
              "firstDateSelect:before" !== t &&
              "firstDateSelect:after" !== t &&
              "secondDateSelect:before" !== t &&
              "secondDateSelect:after" !== t &&
              this.off(t);
      ...
      (a.prototype._render = function (t) {
        ...
        (n.className =
          ...
          void 0 !== t &&
            ...
            this.blackout.addEventListener("click", function (t) {
      ...
      (a.prototype._renderHeader = function () {
        ...
        null !== this.labelFrom &&
          (0, L.createEl)(
            "span",
            { innerText: this.labelFrom, className: "date-label" },
            {},
            e
          ),
          (this.fromDatePlaceholder = (0, L.createEl)(
            "span",
        ...
        null !== this.labelTo &&
          (0, L.createEl)(
            "span",
            { innerText: this.labelTo, className: "date-label" },
            {},
            n
          ),
          (this.toDatePlaceholder = (0, L.createEl)(
            "span",
            { className: "date-placeholder" },
            {},
            n
      ...
      (a.prototype._applyHeaderTitles = function () {
        if (this.showHeader) {
          if (
            ((this.toDatePlaceholder.innerText = this.placeholderText),
            null === this.startDate)
          )
            (this.fromDatePlaceholder.innerText = this.placeholderText),
      ...
      (a.prototype._renderMonthString = function () {
        ...
        if (
          ((this.monthTitle = (0, L.createEl)(
            "span",
            { className: "month-title" },
            {},
            n
          )),
          (0, L.createEl)("span", { innerText: " " }, {}, n),
          this.monthTitle.addEventListener("click", function () {
            t.chooseYearPanel && t.trigger("change:yearPanel"),
              t.trigger("change:monthPanel");
          }),
          (this.yearTitle = (0, L.createEl)(
            "span",
            { className: "year-title" },
            {},
            n
          )),
          this.yearTitle.addEventListener("click", function () {
          ...
          (this.monthTitle2 = (0, L.createEl)(
            "span",
            { className: "month-title" },
            {},
            r
          )),
            (0, L.createEl)("span", { innerText: " " }, {}, r),
            this.monthTitle2.addEventListener("click", function () {
              t.chooseYearPanel && t.trigger("change:yearPanel"),
                t.trigger("change:monthPanel");
            }),
            (this.yearTitle2 = (0, L.createEl)(
              "span",
              { className: "year-title" },
              {},
              r
            )),
            this.yearTitle2.addEventListener("click", function () {
              t.chooseMonthPanel && t.trigger("change:monthPanel"),
                t.trigger("change:yearPanel");
            });
        }
      ...
      (a.prototype._applyMonthStringValues = function () {
        if (
          ((this.monthTitle.innerText = this.longMonthNames.format(
            this.currentDate
          )),
          (this.yearTitle.innerText = (0, c.default)(this.currentDate)),
          this.double)
        ) {
          this.monthTitle2.innerText = this.longMonthNames.format(
            (0, L.plusOneMonth)(this.currentDate)
          );
          var t = (0, c.default)(this.currentDate);
          this.yearTitle2.innerText =
            11 === (0, p.default)(this.currentDate) ? t + 1 : t;
        }
      }),
      (a.prototype._renderMonthChoose = function () {
        var t = this;
        this.monthChooseContainer = (0, L.createEl)(
          "div",
        ...
        this.monthChooseContainer.addEventListener("click", function (e) {
          ...
          t.trigger("change:monthPanel");
          for (var a = 0; a < Math.abs(n - r); a++)
            t.trigger("change:date:reset", (0, v.default)(t.currentDate, r));
        });
      }),
      (a.prototype._renderYearChoose = function () {
        var t = this;
        this.yearChooseContainer = (0, L.createEl)(
          "div",
        ...
        n.addEventListener("click", function (n) {
          ...
          r.addEventListener("click", function (n) {
            n.stopPropagation();
            var r =
                1 * t.yearChooseContainer.getAttribute("data-min-year") + 12,
        ...
        var a = function (e, n, r) {
          ...
          for (
            var a = document.querySelectorAll(".choose-year-label"),
              o = 0,
              i = a.length;
            o < i;
            o++
          )
            t.yearChooseContainer.removeChild(a[o]);
          for (var s = e; s < n; s++)
            (0, L.createEl)(
              "span",
              {
        ...
        a(e - 6, e + 7, e),
          this.yearChooseContainer.addEventListener("click", function (e) {
            var n = e.target.getAttribute("data-year-num");
            null !== n &&
              (t.trigger("change:yearPanel"),
              t.trigger("change:date:reset", (0, f.default)(t.currentDate, n)));
          });
      }),
      (a.prototype._renderWeeksString = function () {
        for (
          var t = (0, L.createEl)("div", { className: "week-name-container" }),
            e = new Date(),
            n = 0;
          n < 7;
          n++
      ...
      (a.prototype._toPreviousMonth = function () {
        ...
        e < 0 &&
          ((n = (0, f.default)(
            this.currentDate,
            (0, c.default)(this.currentDate) - 1
          )),
          (e += 12)),
          (n = (0, v.default)(n, e)),
    ...
    a()
      ...
      (o.prototype._bindDOMEvents = function () {
        ...
        this.daysContainer.addEventListener("click", function (e) {
          ...
          null !== n &&
            "true" !== e.target.getAttribute("data-disabled") &&
            e.target.getAttribute("data-val") &&
            t.trigger("set:date", (0, B.default)(n));
        }),
          a() ||
            this.daysContainer.addEventListener("mousemove", function (e) {
              let dataSource =
                JSON.parse(localStorage.getItem("blockedDays")) || [];
        ...
        this.on("change:startDate", function (e) {
          ...
          this.on("change:hoverDate", function (e) {
            null === t.startDate ||
              (null !== t.startDate && null !== t.endDate) ||
              ((e = (0, B.default)(e)),
              t._applyRangeClasses(t.startDate, e, !0));
          });
      }),
      (o.prototype._calcAvailableRange = function () {
        if (null !== this.disabledDates) {
          ...
          try {
            for (
              var o, i = (0, h.default)((0, l.default)(this.disabledDates));
              !(n = (o = i.next()).done);
              n = !0
            ) {
          ...
          if (
            ...
            (null !== this.startDate && null !== this.endDate)
              ? ((this.tmpMaxDay = null), (this.tmpMinDay = null))
              : ((this.tmpMaxDay = e.length
                  ? (0, L.default)(
                      (0, G.default)(H.default.apply(H.default, e), 1)
                    )
                  : null),
                (this.tmpMinDay = t.length
                  ? (0, L.default)(
                      (0, G.default)(R.default.apply(R.default, t), -1)
                    )
                  : null)),
            null === this.tmpMaxDay && null === this.tmpMinDay)
          )
            for (
              var d = this.calendarContainer.querySelectorAll(".dis-tmp"),
                p = 0,
                g = d.length;
              p < g;
              p++
              ...
              (d[p].className = v
                //.replace("disable-day", "")
                .replace("dis-tmp", "")),
                d[p].setAttribute("data-disabled", "false");
              d[p].removeEventListener("click", noSelectDates, true);
            }
          else this.tmpMaxDay = localStorage.getItem("last");
          this.tmpMinDay = localStorage.getItem("first");
          this.tmpMaxDay = localStorage.getItem("last");
          for (
            var m = this.calendarContainer.querySelectorAll(".day"),
              y = 0,
              D = m.length;
            y < D;
            y++
            ...
            if (
              (null !== this.tmpMaxDay && (0, O.default)(x, this.tmpMaxDay)) >
                0 ||
              (this.tmpMinDay && (0, O.default)(x, this.tmpMinDay) < 0)
            ) {
              if (-1 !== b.indexOf("disable-day")) continue;
              //(m[y].className = b + " disable-day dis-tmp"),
              (m[y].className = b + " dis-tmp"),
                m[y].setAttribute("data-disabled", "true");
              m[y].addEventListener("click", noSelectDates, true);
            }
          }
        }
      }),
      (o.prototype._render = function () {
        (this.daysContainer = (0, z.createEl)(
          "div",
        ...
        for (var e = -2; e <= 2; e++) {
          ...
          n > 11
            ? ((n -= 12),
              (r = (0, x.default)(this.currentDate, n)),
              (r = (0, m.default)(r, (0, g.default)(r) + 1)))
            : n < 1
            ? ((n += 12),
              (r = (0, x.default)(this.currentDate, n)),
              (r = (0, m.default)(r, (0, g.default)(r) - 1)))
      ...
      (o.prototype._renderDaysOfMonth = function (t, e) {
        for (
          var n =
              0 === e
                ...
                ? "prev2"
                : "next2",
            r = (0, T.default)((0, _.default)(t)),
            a = (0, N.default)(t),
            o = (0, z.createEl)(
              "div",
              { "data-days-counter": r + a, className: "days-page " + n },
              {},
              this.daysContainer
            ),
            i = 0;
          i < (this.mondayIsFirst ? r - 1 : r);
          i++
        ) {
          (0, z.createEl)(
            "span",
            { className: "void-day", innerText: "" },
            {},
            o
          );
        }
        for (var s = 1; s <= a; s++) {
          var u = (0, L.default)((0, E.default)(t, s)),
            ...
            c =
              (null !== this.minDate &&
                -1 === (0, O.default)(u, this.minDate)) ||
              (null !== this.maxDate && -1 === (0, O.default)(this.maxDate, u));
          c ||
            null === this.disabledDates ||
            (c = void 0 !== this.disabledDates[l]),
            (0, z.createEl)(
              "span",
              {
        ...
        const daysOne = document.getElementsByClassName("days-container")[1];

        if (daysOne !== undefined) {
          daysOne.addEventListener("click", () => {
            discount = flaw ? 1 : 2;
            // if (flaw) {
            //   flaw = false;
            // }
        ...
        document
          .getElementsByClassName("days-container")[0]
        ...
        const dayParents = document.querySelectorAll(".days-page.curr");
        if (dayParents && dayParents[0] && dayParents[1]) {
          let firstCalendar = dayParents[0].lastElementChild.getAttribute(
            "data-val"
          );
          let lastCalendar = dayParents[1].lastElementChild.getAttribute(
            "data-val"
          );

          let firstDate = new Date(firstCalendar);
          let firstDateLimit = new Date(
          ...
          while (
            ...
            firstDateLimit.toISOString().slice(0, 10)
          ) {
            firstDate.setDate(firstDate.getDate() + 1);
            const noShow = document.querySelector(
              `.day[data-val='${firstDate.toISOString().slice(0, 10)}']`
            );
            if (noShow) {
              noShow.classList.add("no-show-zone");
            }
          }
        }
      }),
      (o.prototype._applyDaysPageClasses = function () {
        1 * this.pages.prev.getAttribute("data-days-counter") < 35 &&
          (this.pages.prev.className =
            this.pages.prev.className + "-short-week"),
          1 * this.pages.curr.getAttribute("data-days-counter") < 35 &&
            (this.pages.next.className =
              this.pages.next.className + "-short-week");
      }),
      (o.prototype._applyRangeClasses = function (t, e, n) {
        if (!this.singleDate) {
          if (
            ...
            null !== this.tmpMaxDay &&
              null !== e &&
              (e = (0, O.default)(this.tmpMaxDay, e) > 0 ? e : this.tmpMaxDay),
            null !== this.tmpMinDay &&
              null !== e &&
              (e = (0, O.default)(this.tmpMinDay, e) < 0 ? e : this.tmpMinDay),
            (null !== t && null === e) || n)
          )
            for (
              var r = this.daysContainer.querySelectorAll(".day.activeRange"),
                a = 0,
                o = r.length;
              a < o;
              a++
          ...
          if (null !== t && null !== e) {
            const tmpMaxArr = document.querySelectorAll(
              `[data-val="${this.tmpMaxDay}"]`
            );
            for (let i = 0; i < tmpMaxArr.length; i++) {
              tmpMaxArr[i].classList.add("middle-day");
            }
            const tmpMinArr = document.querySelectorAll(
              `[data-val="${this.tmpMinDay}"]`
            );
            for (let i = 0; i < tmpMinArr.length; i++) {
              tmpMinArr[i].classList.add("middle-day-last");
            }
            ...
            if (0 !== (0, O.default)((0, L.default)(t), (0, L.default)(e)))
              for (var l = 0, c = u.length; l < c; l++) {
                var h = (0, Y.default)(u[l], "YYYY-MM-DD"),
                  f = this.daysContainer.querySelector(
                    'span[data-val="' + h + '"]'
                  );
                f &&
                  (f.className =
                    "day activeRange" +
                    (0 === l ? " first" : l === c - 1 ? " last" : ""));
              }
          }
        }
      }),
      (o.prototype._setActiveDays = function () {
        for (
          var t = this.daysContainer.querySelectorAll(".day.active"),
            e = 0,
            n = t.length;
          e < n;
          e++
        ...
        if (null !== this.startDate) {
          var r = this.daysContainer.querySelector(
            'span[data-val="' +
              (0, Y.default)(this.startDate, "YYYY-MM-DD") +
              '"]'
          );
          r && (r.className = "day active");
        }
        if (null !== this.endDate) {
          var a = this.daysContainer.querySelector(
            'span[data-val="' +
              (0, Y.default)(this.startDate, "YYYY-MM-DD") +
              '"]'
          );
      ...
      (o.prototype._addMonthAfterNext = function () {
        ...
        e > 11
          ? ((e -= 12),
            (n = (0, x.default)(this.currentDate, e)),
            (n = (0, m.default)(n, (0, g.default)(n) + 1)))
          : (n = (0, x.default)(this.currentDate, e)),
      ...
      (o.prototype._applyWeekFullClassNames = function () {
        (this.pages.prev2.className = "days-page prev2"),
          1 * this.pages.prev.getAttribute("data-days-counter") < 35
            ? (this.pages.prev.className = "days-page prev-short-week")
            : (this.pages.prev.className = "days-page prev"),
          (this.pages.curr.className = "days-page curr"),
          1 * this.pages.curr.getAttribute("data-days-counter") < 35
            ? (this.pages.next.className = "days-page next-short-week")
            : (this.pages.next.className = "days-page next"),
  ...
  function (t, e, n) {
    ...
    t.exports = n(7)
      ...
      : function (t, e) {
          a(t);
          for (var n, i = o(e), s = i.length, u = 0; s > u; )
            r.f(t, (n = i[u++]), e[n]);
          return t;
        };
  },
  ...
  function (t, e, n) {
    ...
    t.exports = function (t) {
      return function (e) {
        for (var n, i = a(e), s = r(i), u = s.length, l = 0, c = []; u > l; )
          o.call(i, (n = s[l++])) && c.push(t ? [n, i[n]] : i[n]);
        return c;
      };
    };
  },
  ...
  function (t, e, n) {
    function r(t, e, n) {
      ...
      var u = [],
        l = r;
      for (l.setHours(0, 0, 0, 0); l.getTime() <= s; )
        u.push(a(l)), l.setDate(l.getDate() + i);
      return u;
    }
    var a = n(0);
    t.exports = r;
